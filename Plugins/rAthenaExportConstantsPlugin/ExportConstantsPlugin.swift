...
struct ExportConstantsPlugin: CommandPlugin {
    ...
    func performCommand(context: PluginContext, arguments: [String]) async throws {
        ...
        let output1 = context.package.directory.appending(["Sources", "rAthenaCommon", "RAConstant.h"])
        let output2 = context.package.directory.appending(["Sources", "rAthenaCommon", "RAConstant.mm"])
    ...
    private func objectiveCPlusPlus(_ constants: [Constant], _ uniqueConstantValues: [String]) -> String {
        ...
        @implementation RAConstant

        + (NSDictionary<NSString *, RAConstant *> *)allConstants {
            static NSDictionary<NSString *, RAConstant *> *allConstants = nil;
            static dispatch_once_t onceToken;
            dispatch_once(&onceToken, ^{
                allConstants = @{
        \(constants.map({ "            @\"\($0.name)\": [RAConstant constantWithName:@\"\($0.name)\" value:\($0.value)]," }).joined(separator: "\n"))
                };
            });
            return allConstants;
        }
