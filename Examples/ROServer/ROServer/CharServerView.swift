...
struct CharServerView: View {
    ...
    var body: some View {
        ServerView("Char Server", startAction: startServer, pendingLog: $pendingLog, pendingSession: $pendingSession)
        .task {
            ServerManager.shared.charServerOutputHandler = { data in
...
struct CharServerView_Previews: PreviewProvider {
